...
const VALID_ROUTES = new Set<string>(ROUTES.map((route) => route.id));
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="logo">IUPAC</span>
          Nomenclature playground
        </h1>
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            title="IUPAC nomenclature reference"
          ...
          <a
            ...
            className="header-link header-link--icon-only"
          >
            <svg
              role="img"
              aria-hidden="true"
